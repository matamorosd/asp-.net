<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="false" CodeFile="Mantenimiento_Tipo.aspx.vb" Inherits="Control_Inventario_Mantenimiento_Tipo" %>
...
<script type="text/javascript">
		$(document).ready(function() {
			$.notification( 
			{
			    title: "Mantenimiento de Tipo de Material",
				content: "Agregue, Modifique o Elimine Tipo de Material.",
	...
	<div class="content_pad">
		...
		<ul id="nav">
			...
			<li class="nav_dropdown nav_icon nav_current">
				<a href="javascript:;"><span class="ui-icon ui-icon-gripsmall-diagonal-se"></span>Mant. Tipo Mat.</a>
				<div class="nav_menu">
					<ul>
...
<div id="masthead">
	<div class="content_pad">
		...
		<div id="bread_crumbs">
			...
			<a href="" class="current_page">Mantenimiento de Tipo Mat.</a>
		 </div> <!-- #bread_crumbs -->
	</div> <!-- .content_pad -->
</div> <!-- #masthead -->
	...
	<div id="content" class="xgrid">
		...
		<br/>
			<div class="portlet x12">
				...
				<h3>Mantenimiento de Tipo de Material</h3>
					<table class="data display datatable" id="tblMaterialesAgregados">
						...
						<tbody id="cols">
						    ...
						    Try
							        ...
							        Dim Sql As String = "select * from tipo_material"
			...
			<br><br><br><br>
			<div class="portlet x12" id="divTipoMaterial" style="display:none;">
				<div class="portlet-content">
				<h3><span class="orange" id="divAccion"></span></h3>
					<div class="field">
						<label for="txtCodigo">C&oacute;digo</label>
						<input id="txtCodigo" name="txtCodigo" value="" size="10" type="text" class="small" placeholder="C&oacute;digo del Tipo" disabled="disabled" />
					</div>
					<div class="field">
						<label for="txtNombre">Nombre</label>
						<input id="txtNombre" type="text" class="large" placeholder="Nombre del Tipo de Material">
					</div>
					<div>
...
<script type="text/javascript">
 ...
 function Borrar(id)
	{
		$.msgbox("Esta seguro de desea eliminar el Tipo de Material?.<br/><br/> Desea continuar?", {
		  type: "confirm",
		  buttons : [
		    ...
		    {type: "cancel", value: "Cancelar"}
			  ...
			  if(result == "Si")
			  {
			    ...
			    {
			        type: "POST",
			        url: "Mantenimiento_Tipo.aspx/BorrarTipo",
			        data: '{ pReferencia: "' + id + '" }',
...
$("#btnAceptar").click(function()
		{
			...
			if(opcion == "Agrega Tipo de Material")
			{
				var result = $.ajax(
			    {
			        type: "POST",
			        url: "Mantenimiento_Tipo.aspx/AgregarTipo",
			...
			else if(opcion == "Modifica Tipo de Material")
			{
				var result = $.ajax(
			    {
			        type: "POST",
			        url: "Mantenimiento_Tipo.aspx/ModificarTipo",
 ...
 function Modificar(id)
	{
		...
		$("#divAccion").text("Modifica Tipo de Material");
		var result = $.ajax(
	    {
	        type: "POST",
	        url: "Mantenimiento_Tipo.aspx/CargaDatos",
	        data: '{ pReferencia: "' + id + '" }',
	        contentType: "application/json; charset=utf-8",
	        dataType: "json",
	        success: CargaD,
	...
	{	
		...
		if (msg.d >= 1)
		{
			...
			window.location.reload("Mantenimiento_Tipo.aspx");
		}
		else
		{
			$.notification( 
	...
	$("#btnAgregar").click(function()
		{
			...
			$("#txtNombre").val("");
			$("#divTipoMaterial").show();	
			$("#divAccion").text("Agrega Tipo de Material");
			$("#txtNombre").focus();
		});
</script>
<script type="text/javascript">
