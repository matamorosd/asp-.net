...
<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="false" CodeFile="ReporteEntrada.aspx.vb" Inherits="Control_Inventario_ReporteEntrada" %>
...
<div id="header">
		...
		<div class="content_pad">
			...
			<ul id="nav">
				...
				<li class="nav_dropdown nav_icon nav_current">
					<a href="javascript:;"><span class="ui-icon ui-icon-gripsmall-diagonal-se"></span>Reporte Entradas</a>
					<div class="nav_menu">			
						<ul>
							<li><a href="SeleccionReporte.aspx">Reportes</a></li>
							<li><a href="MaterialDisponible.aspx">Mat. Disponible</a></li>
							<li><a href="ReporteSalida.aspx">Salida Mat.</a></li>
						</ul>	
					</div>
				</li>
			</ul>
    ...
    <div id="masthead">
		...
		<div class="content_pad">
			...
			<div id="bread_crumbs">
				...
				<a href="" class="current_page">Reporte de Entrada</a>
			 </div> <!-- #bread_crumbs -->
		...
		<div id="content" class="xgrid">
			...
			<div class="portlet x6">
				<div class="portlet-content">
					...
					<input type="checkbox" id="chkProveedor">
					<br>
					<label for="cmbProveedor">Proveedor </label>
					<select id="cmbProveedor" class="medium" disabled="disabled">
	...
	<script type="text/javascript">
		...
		{
			if(frmDatos.chkProveedor.checked == false)
			{
		...
		{
			$("#picLoading").show();
			$("#cmbMaterial option").remove();
			var pProveedor = $("#cmbProveedor").val();
			var result = $.ajax(
		    {
		        type: "POST",
		        url: "ReporteEntrada.aspx/BuscarMaterial",
		        data: '{ pProveedor: "' + pProveedor + '", Accion: "'+ Accion +'" }',
		        contentType: "application/json; charset=utf-8",
		        dataType: "json",
		        success: CargarMaterial,
		...
		function CargarMaterial(msg)
		{
			var Material = $('#cmbMaterial'); 
			$("#picLoading").hide();
			Material.append($(msg.d)); 
		}
...
<script type="text/javascript">
	...
	$("#btnGenerar").click(function()
	{
	    ...
	    {
	        type: "POST",
	        url: "ReporteEntrada.aspx/Generar",
 ...
 function Condiciones(pCondiciones)
 {
 	...
 	var FechaFin = $("#txtFechaFin").val();
		...
		{
			pCondiciones += " and e.entrada_proveedor = '"+ Proveedor +"'";
		}
		if(frmDatos.chkMaterial.checked == true)
		{
			pCondiciones += " and ed.entrada_material = '"+ Material +"'";
		}
		if(frmDatos.chkFechas.checked == true)
		{
			if(FechaFin.length == 0)
			{
				pCondiciones += " and e.entrada_fecha = '"+ FechaInicio +"'";
			}
			else
			{
				pCondiciones += " and e.entrada_fecha between '"+ FechaInicio +"' and '"+ FechaFin +"'";
			}
		}
		return pCondiciones;
 }
...
<script type="text/javascript">
	function VerGrafica(Codigo)
	{
	    ...
	    {
	        type: "POST",
	        url: "ReporteEntrada.aspx/CargarGrafica",
