<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="false" CodeFile="Mantenimiento_Clientes.aspx.vb" Inherits="Control_Inventario_Mantenimiento_Clientes" %>
...
<script type="text/javascript">
		$(document).ready(function() {
			$.notification( 
			{
				...
				content: "Agregue, Modifique o Elimine Clientes",
	...
	<div class="content_pad">
		...
		<ul id="nav">
			...
			<li class="nav_dropdown nav_icon nav_current">
				<a href="javascript:;"><span class="ui-icon ui-icon-gripsmall-diagonal-se"></span>Mant. Clientes</a>
				<div class="nav_menu">			
					<ul>
...
<div id="masthead">
	<div class="content_pad">
		...
		<div id="bread_crumbs">
			...
			<a href="" class="current_page">Mantenimiento de Clientes</a>
		 </div> <!-- #bread_crumbs -->
	</div> <!-- .content_pad -->
</div> <!-- #masthead -->
...
<form id="frmDatos" class="form label-inline uniform" onsubmit="return false;">
	<div id="content" class="xgrid">
		...
		<br/>
			...
			<br><br><br><br>
			<div class="portlet x12" id="divCliente" style="display:none;">
				<div class="portlet-content">
				<h3><span class="orange" id="divAccion"></span></h3>
					<div class="field">
						<label for="txtCodigo">C&oacute;digo</label>
						<input id="txtCodigo" name="txtCodigo" value="" size="10" type="text" class="small" placeholder="C&oacute;digo del Cliente" disabled="disabled" />
					</div>
					<div class="field">
						<label for="txtNombre">Nombre</label>
						<input id="txtNombre" type="text" class="large" placeholder="Nombre del Cliente">
					</div>
					<div>
 ...
 function Borrar(id)
	{
		...
		$.msgbox("Esta seguro de desea eliminar el Cliente?.<br/><br/> Desea continuar?", {
		  type: "confirm",
		  buttons : [
		    ...
		    {type: "cancel", value: "Cancelar"}
			  ...
			  if(result == "Si")
			  {
			    ...
			    {
			        type: "POST",
			        url: "Mantenimiento_Clientes.aspx/BorrarCliente",
			        data: '{ pReferencia: "' + id + '" }',
...
$("#btnAceptar").click(function()
		{
			...
			if(opcion == "Agrega Cliente")
			{
				var result = $.ajax(
			    {
			        type: "POST",
			        url: "Mantenimiento_Clientes.aspx/AgregarCliente",
			...
			else if(opcion == "Modifica Cliente")
			{
				var result = $.ajax(
			    {
			        type: "POST",
			        url: "Mantenimiento_Clientes.aspx/ModificarCliente",
 ...
 function Modificar(id)
	{
		$("#divCliente").show();
		$("#divAccion").text("Modifica Cliente");
		var result = $.ajax(
	    {
	        type: "POST",
	        url: "Mantenimiento_Clientes.aspx/CargaDatos",
	        data: '{ pReferencia: "' + id + '" }',
	        contentType: "application/json; charset=utf-8",
	        dataType: "json",
	        success: CargaD,
	...
	{	
		...
		if (msg.d >= 1)
		{
			...
			window.location.reload("Mantenimiento_Clientes.aspx");
		}
		else
		{
			$.notification( 
