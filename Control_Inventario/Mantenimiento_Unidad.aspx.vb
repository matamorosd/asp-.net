...
Partial Class Control_Inventario_Mantenimiento_Unidad
    ...
    Public Shared Function BorrarUnidad(pReferencia As String) As String
        Dim cnn As New conexion
        Dim Sql As String = "delete from unidad_medida where unidad_codigo = '" + pReferencia + "'"
    ...
    <WebMethod(EnableSession:=True)>
    Public Shared Function ModificarUnidad(pReferencia As String, pNombre As String) As String
        Dim cnn As New conexion
        Dim Sql As String = "update unidad_medida set unidad_descripcion = '" + pNombre + "' where unidad_codigo = '" + pReferencia + "'"
        Dim Retorno As String = ""
        Try
            Retorno = cnn.EjecutarInsertUpdateInventario(Sql)
        Catch ex As Exception
    ...
    <WebMethod(EnableSession:=True)>
    Public Shared Function AgregarUnidad(pNombre As String) As String
        Dim cnn As New conexion
        Dim Retorno As String = ""
        Dim SqlCorrelativo As String = "select max(unidad_codigo)+1 from unidad_medida"
        ...
        If IsNothing(Correlativo) Or Correlativo = 0 Then
            Correlativo = 1
        End If
        Dim Sql As String = "INSERT INTO unidad_medida (`unidad_Codigo`, `unidad_descripcion`) VALUES ('" + Correlativo.ToString + "', '" + pNombre + "');"
        Try
            Retorno = cnn.EjecutarInsertUpdateInventario(Sql)
        Catch ex As Exception
            Retorno = ex.Message
    ...
    Public Shared Function CargaDatos(pReferencia As String) As String
        Dim cnn As New conexion
        Dim Sql As String = "select * from unidad_medida where unidad_codigo = '" + pReferencia + "'"
